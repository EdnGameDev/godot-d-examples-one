...
public:
	...
	void set_audio_bus(StringArg0)(in StringArg0 name)
	{
	...
	void set_reverb_bus(StringArg0)(in StringArg0 name)
	{
	...
	package(godot) static GodotMethod!(void, float) _GODOT_set_reverb_amount;
	...
	package(godot) static GodotMethod!(float) _GODOT_get_reverb_amount;
	...
	float get_reverb_amount() const
	{
		...
		return ptrcall!(float)(_GODOT_get_reverb_amount, _godot_object);
	}
	package(godot) static GodotMethod!(void, float) _GODOT_set_reverb_uniformity;
	...
	package(godot) static GodotMethod!(float) _GODOT_get_reverb_uniformity;
	...
	float get_reverb_uniformity() const
	{
		...
		return ptrcall!(float)(_GODOT_get_reverb_uniformity, _godot_object);
	}
}
